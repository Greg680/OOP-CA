...
public class Quiz {
   ...
   public Quiz(){
       questions = QuizApp.getqQuestion();
       scoreS = new Score(questions.size());
   }
   ...
   public QuizApp currentQuestion(){ //gets the current question and if no more questions left ends the quiz
   ...
   public int getTotQuestions(){
       return questions.size();
        ...
        //need to have more than 3 classes: Quiz(main), QuizApp(settings questions in a file) and QuizGUI so far but thinking of (class for random questions?)
